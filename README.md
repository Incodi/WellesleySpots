...
- Can click a review on the map and View Details to see an expanded version of the review with a placeholder for a comments section that will be implemented in a future version
4. Go back to all reviews and can create review on that same page in form
- Each field, except for photo and photo caption, must be filled out
